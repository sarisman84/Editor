#pragma once
#include "../Engine/tge/math/Vector.h"
...
namespace CommonUtilities
{
	...
	public:
		...
		static void SetVisibility(const bool& aState);
		static void SetCaptureState(const CaptureState aState);
	...
	private:
		...
		static CaptureState ourCaptureState;
		static HCURSOR ourInstance;
	};
